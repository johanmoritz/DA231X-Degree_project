...
\todoinline{Describe what an endorsement policy is and its purpose}

\todoinline{Chaincode-level endorsement}

\todoinline{Collection-level endorsement}

\todoinline{Key-level endorsement}
