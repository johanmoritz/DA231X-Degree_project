...
% 
% 	Some "bad" behaviours:
% 		- Peers add different .buildinfo files all the time and none is verified by multiple peers
% 		- Peers don't actually build packages, instead they just pretend that they did
% 
% 		
% 	"Dutch auction" asset management solution:
% 		1. For each new .buildinfo file: a submission process that looks like an auction begins. A unique_auction_id is created and stored on the ledger.
