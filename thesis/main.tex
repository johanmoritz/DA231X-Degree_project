...
Besides $\Box$, another common temporar operator is called \textit{eventually} and written $\Diamond$. $\Diamond F$ can be described as 
...
\todoinline{Add work on specifying systems to analyse security properties}
