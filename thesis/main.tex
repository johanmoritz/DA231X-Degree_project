...
To develop and study the judgment algorithm, a model was created as a TLA\textsuperscript+ specification. This section seek to describe how this model is structured and to detail its core components. The specification has been split into three parts with some details removed to make the explanation more manageble for the reader. A full version of the specification can be found in appendix \ref{ch:TLAPlusFullModel}. This section has been divided into \ref{subsec:ModelData} on the data structures used in the model, chaincode definitions in \ref{subsec:ModelChaincode} and how system actors interact under \ref{subsec:ModelSpec}.
...
\begin{lstlisting}[caption=Model of chaincode]
	µ\subfile{model/Chaincode}µ
\end{lstlisting}

\subsection{Specification}
\label{subsec:ModelSpec}

\begin{lstlisting}[caption=System actor behaviour in TLA\textsuperscript+ specification]
	µ\subfile{model/Specification}µ
\end{lstlisting}
